...
// Требуется объем динамической памяти не менее 2,5 кБ.                //
                                                                       //
...
iarduino_OLED myOLED_1(0x3C);                                          // Создаём объект myOLED_1, указывая адрес первого дисплея на шине I2C: 0x3C.
iarduino_OLED myOLED_2(0x3D);                                          // Создаём объект myOLED_2, указывая адрес второго дисплея на шине I2C: 0x3D.
                                                                       // 
void setup(){                                                          //
