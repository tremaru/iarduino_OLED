// ПРИМЕР ВЫВОДА ПРИМИТИВОВ ПО КОМАНДЕ UPDATE:                         //
                                                                       //
// В коде setup() данного примера вызвана функция autoUpdate(false),   //
// это приводит к тому, что примитивы выводятся не на экран, а в буфер.// 
// После обращения к myOLED.update() экран обновляется данными буфера. //
// В примере ShowFigures выводятся те же примитивы, но сразу на экран. //
                                                                       //
